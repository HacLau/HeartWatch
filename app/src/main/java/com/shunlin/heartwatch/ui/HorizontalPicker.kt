...
class HorizontalPicker : View {
    ...
    private fun initAttrs(attrs: AttributeSet?) {
        ...
        selectedColor = tta.getColor(R.styleable.HorizontalPicker_selectedTextColor, context!!.resources.getColor(R.color.record_degree_0))
        textSize = tta.getFloat(R.styleable.HorizontalPicker_normalTextSize, 50.0f)
        textColor = tta.getColor(R.styleable.HorizontalPicker_normalTextColor, context!!.resources.getColor(R.color.record_degree_0))
    }
